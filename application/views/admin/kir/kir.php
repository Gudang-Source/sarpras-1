...
?>
<title>SIBASWA-SMK WALISONGO PECANGAAN</title>
<style>
td {
...
<!--</table>-->
  <tr>
    <td nowrap width="10"><strong>UNIT</strong></td><td width="50"></td><td ><?php echo nbs(12); ?> :YAYASAN WALISONGO PECANGAAN</td>
  </tr>
  <br>
  <tr>
    <td nowrap width="10"><strong>Unit Kerja</strong></td><td width="50"></td><td ><?php echo nbs(10); ?>:SMK WALISONGO PECANGAAN</td>
  </tr>
  <br>
  <tr>
    <td nowrap width="10"><strong>Lokasi</strong></td><td width="50"></td><td ><?php echo nbs(6); ?> :Yayasan Walisongo Pecangaan</td>
  </tr>
<br>
<br>
