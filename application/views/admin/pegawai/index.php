<div id="main-content">
          ...
          <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h4><i class="icon-user"></i> Guru/Karyawan</h4>
                    </div>
  ...
  <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-header">
        ...
        <h4 id="myModalLabel1">Tambah Guru/Karyawan</h4>
    </div>
    ...
    <div class="modal-body">
        <div class="control-group">
            <div class="row">
                 ...
                 <label class="span3">NIK/NUPTK Guru/Karyawan</label>
                <div class="span8">
                    <div class="controls">
            ...
            <div class="row">
                 <label class="span1"></label>
                 <label class="span3">Kelompok Kerja</label>
                <div class="span8">
                    <div class="controls">
