...
<!-- BEGIN BODY -->
<body class="lock">
<div width="50" style="background-color:#385da4;"><marquee><h3><strong><i style="color:white;">SIBASWA (Sistem Informasi Barang SMK Walisongo Pecangaan)</i></strong></h3></marquee></div>
    <div class="lock-header">
    </div>
        
        <div class="row-fluid">
            <div class="span4">
                <center><img src="<?php echo base_url('assets/logo/yws.jpg'); ?>" width="200px" height="300px" alt=""></center>
            </div>
             <div class="span4">
             ...
             <div class="span4">
                <center><img src="<?php echo base_url('assets/logo/smkw9.png'); ?>" width="250px" height="300px" alt=""></center>
            </div>
            <div id="footer">
